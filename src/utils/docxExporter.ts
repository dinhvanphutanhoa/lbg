      ...
      new TableRow({
        ...
        children: [
          new TableCell({
            ...
            shading: { fill: "1E3A8A" },
            children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: isEnPlan ? "TEACHER'S ACTIVITIES (T)" : "HOẠT ĐỘNG CỦA GIÁO VIÊN (HĐGV)", bold: true, color: "FFFFFF", font, size: baseSize })] })],
          }),
          new TableCell({
            width: { size: colHalfWidth, type: WidthType.DXA },
            shading: { fill: "1E3A8A" },
            children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: isEnPlan ? "STUDENTS' ACTIVITIES (Ss)" : "HOẠT ĐỘNG CỦA HỌC SINH (HĐHS)", bold: true, color: "FFFFFF", font, size: baseSize })] })],
          }),
        ],
      }),
    ];
